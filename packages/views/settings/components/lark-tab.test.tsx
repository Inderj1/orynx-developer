...
// row uses it to render the Orynx agent's name in place of the raw
...
// renders the Orynx agent's avatar + name (joined via inst.agent_id),
...
describe("LarkTab connected bots list (agent identity rendering)", () => {
  ...
  it("renders the Orynx agent's name and avatar instead of the raw Lark app_id / bot_open_id", () => {
