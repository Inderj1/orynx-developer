...
// install path is per-agent (each Orynx Agent gets exactly one Bot —
...
function InstallationRow({
  ...
  const { t } = useT("settings");
  // The bot is bound 1:1 to a Orynx Agent (per the (workspace_id,
  // agent_id) UNIQUE in lark_installation). Render the Orynx agent's
