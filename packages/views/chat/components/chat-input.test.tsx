...
function renderInput(props: Partial<React.ComponentProps<typeof ChatInput>> = {}) {
  ...
  render(
    <I18nProvider locale="en" resources={TEST_RESOURCES}>
      <ChatInput onSend={onSend} onUploadFile={onUploadFile} agentName="Orynx" {...props} />
    </I18nProvider>,
  );
...
function element(props: Partial<React.ComponentProps<typeof ChatInput>>) {
  return (
    <I18nProvider locale="en" resources={TEST_RESOURCES}>
      <ChatInput onSend={vi.fn()} onUploadFile={vi.fn()} agentName="Orynx" {...props} />
    </I18nProvider>
  );
}
...
describe("ChatInput focusRequest", () => {
  it("focuses the editor when focusRequest becomes a non-zero value (new chat)", () => {
    const { rerender } = render(
      <I18nProvider locale="en" resources={TEST_RESOURCES}>
        <ChatInput onSend={vi.fn()} agentName="Orynx" focusRequest={0} />
      </I18nProvider>,
    );
    ...
    rerender(
      <I18nProvider locale="en" resources={TEST_RESOURCES}>
        <ChatInput onSend={vi.fn()} agentName="Orynx" focusRequest={1} />
      </I18nProvider>,
    );
    ...
    rerender(
      <I18nProvider locale="en" resources={TEST_RESOURCES}>
        <ChatInput onSend={vi.fn()} agentName="Orynx" focusRequest={2} />
      </I18nProvider>,
    );
