...
description: When Orynx notifies you, and how to mute issues you don't care about.
---

import { Callout } from "fumadocs-ui/components/callout";

The inbox is where Orynx **interrupts** you — [issues](/issues) assigned to you, [`@` mentions](/comments), and activity on issues you're subscribed to all land here.
