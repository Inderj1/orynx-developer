...
description: Install the Orynx CLI and start the agent daemon.
---
...
This configures the CLI for Orynx Cloud, opens your browser for login, discovers your workspaces, and starts the agent daemon.
