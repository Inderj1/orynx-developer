...
import App from "./App";
// Space Grotesk variable font (Agentic Workspace theme) covers all weights in a
// single file. JetBrains Mono variable for code/labels; CJK is handled by system
// font fallback (see globals.css --font-sans chain). Keep font stack in sync with
