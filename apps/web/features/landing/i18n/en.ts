...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    subheading:
      "Orynx is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "Orynx board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Orynx scans for 14 supported coding tools \u2014 Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Qoder, and Trae CLI \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  openSource: {
    ...
    description:
      "Orynx is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Orynx on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Orynx support?",
        answer:
          "Orynx supports 14 coding tools out of the box: Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Qoder, and Trae CLI. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
        question: "Do I need to self-host, or is there a cloud version?",
        answer:
          "Both. You can self-host Orynx on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Orynx adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Orynx manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Orynx servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  footer: {
    ...
    copyright: "\u00a9 {year} Orynx. All rights reserved.",
  },
  ...
  about: {
    ...
    paragraphs: [
      ...
      "We think the same inflection is happening again. For decades, software teams have been single-threaded \u2014 one engineer, one task, one context switch at a time. AI agents change that equation. Orynx brings time-sharing back, but for an era where the \u201cusers\u201d multiplexing the system are both humans and autonomous agents.",
      "In Orynx, agents are first-class teammates. They get assigned issues, report progress, raise blockers, and ship code \u2014 just like their human colleagues. The assignee picker, the activity timeline, the task lifecycle, and the runtime infrastructure are all built around this idea from day one.",
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Orynx.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        features: [
          ...
          "Self-hosted (Helm): a new `postgres.external.enabled` toggle points Orynx at an externally managed PostgreSQL (RDS, CNPG, Cloud SQL, Neon…) and skips the built-in database.",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Slack's native /issue slash command creates a Orynx Issue and replies to you privately with the link.",
          "A Slack user who already linked their account to one Orynx bot no longer re-links when the same Slack workspace connects a second bot.",
        ...
        fixes: [
          ...
          "Anonymous self-host source-channel reports go back to the official Orynx API endpoint.",
      ...
      },
      {
        ...
        features: [
          ...
          "Slack channels can backfill their conversation history into Orynx, so an agent has the prior context the moment it joins.",
      ...
      },
      {
        ...
        improvements: [
          "The local daemon reconnects to Orynx through a more resilient WebSocket flow with bounded backoff, so brief network drops recover smoothly instead of stalling.",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "CodeBuddy can now run local Orynx agents, with its available model and effort choices shown automatically",
      ...
      },
      {
        ...
        features: [
          ...
          "Claude Fable 5 is now available in Orynx's supported model and pricing list",
          ...
          "Lark and Feishu conversations now show a typing reaction while Orynx is preparing a reply, then clear it before the answer is sent",
          "Agent runs now know who started each task, making handoffs, audit trails, and privacy-aware behavior more accurate",
          "OpenClaw users can point Orynx at a custom app location and data folder from their local configuration",
        ],
        improvements: [
          "Comment trigger indicators are quieter, clearer, and less likely to crowd long agent names",
          "Desktop now disables daemon start and stop controls when the daemon is managed outside Orynx, such as in WSL2",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "The web app can now show native browser notification banners, making workspace activity easier to catch while Orynx is in the background",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Orynx now supports Lark as a third-party integration, so teams can scan a QR code and create a Orynx agent as a Lark Bot",
          ...
          "Agents now include built-in Orynx skills so they can follow workspace workflows more consistently",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Orynx now supports Japanese across the app, site, and docs",
      ...
      },
      {
        ...
        features: [
          ...
          "Orynx now supports Korean across the app, public site, and documentation, including Korean docs pages and localized date formatting",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Orynx shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Orynx for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Orynx for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Orynx to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Orynx tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New users now enter a guided welcome experience where Orynx Helper can introduce the workspace, give a tour, or build a slide-style welcome page",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Orynx",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Orynx issues, sync their status, and close the Orynx issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Orynx app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Orynx asterisk",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Orynx Agent commits include a `Co-authored-by` trailer for proper Git attribution",
  ...
  contactSales: {
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Orynx?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Orynx or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Orynx for my team" },
      { value: "adopt_team", label: "Rolling out Orynx to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Orynx with existing tools" },
    ...
    consent: {
      intro:
        "Orynx, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Orynx, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Orynx.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Orynx, Inc. to store and process your information for the purpose of delivering the requested content.",
    ...
    success: {
      ...
      message:
        "A member of the Orynx team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
