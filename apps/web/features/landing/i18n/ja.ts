...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Orynx は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "営業に相談する",
      worksWith: "対応ツール",
      imageAlt: "人間と AI エージェントがイシューを管理する Orynx のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。タスクをキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を Orynx が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Orynx は Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI という14種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    ...
    openSource: {
      ...
      description:
        "Orynx は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Orynx を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        {
          question: "Orynx はどのコーディングエージェントに対応していますか?",
          answer:
            "Orynx は、Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI の14種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。オープンソースなので、独自のバックエンドを追加することもできます。",
        },
        {
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Orynx はその上に、タスクキュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間のタスクを自律的にこなせますか?",
          answer:
            "はい。Orynx は、キュー追加・受け取り・実行・完了または失敗まで、タスクのライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Orynx のサーバーを経由することはありません。プラットフォームはタスクの状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Orynx の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Orynx を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで Orynx Issue を作成し、実行者だけに Issue リンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Orynx ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          fixes: [
            ...
            "セルフホストの匿名ソース チャネル送信先を正式な Orynx API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを Orynx にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Orynx に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Orynx エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5 が Orynx の対応モデルと料金一覧に加わりました。",
            "イシューの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Orynx が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Orynx の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Orynx がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Orynx は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Orynx エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックボックス付きタスクリストを使えるようになり、イシュー内の軽い計画を整理しやすくなりました。",
            "エージェントに Orynx の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Orynx がアプリ、サイト、ドキュメントで日本語に対応しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Orynx がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Orynx for iOS をリリースし、ログイン・ワークスペース・インボックス・イシュー・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "新規ユーザーは、Orynx Helper がワークスペースの紹介、ツアー、ウェルカムページ作成まで案内する新しいオンボーディング体験を利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Orynx のイシューに表示し、状態を同期し、PR がクローズされたときにイシューを自動的に閉じられます。",
        ...
        },
        {
          ...
          improvements: [
            "デーモンの claim polling の Redis fast-path、Orynx Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
    ...
    about: {
      ...
      paragraphs: [
        ...
        "いま、同じような転換点がふたたび訪れていると私たちは考えています。この数十年、ソフトウェアチームは事実上シングルスレッドで働いてきました。一人のエンジニアが、ひとつのタスクを担い、一度にひとつの文脈だけを切り替えながら進める。AI エージェントは、その方程式を変えます。Orynx はタイムシェアリングをふたたび呼び戻します。ただし今回は、システムを多重利用する「ユーザー」が、人間と自律的なエージェントの両方である時代に合わせて。",
        "Orynx では、エージェントは一級のチームメンバーです。人間の同僚とまったく同じように、イシューを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードをリリースします。担当者の選択、アクティビティタイムライン、タスクのライフサイクル、そしてランタイムのインフラは、すべてこの前提を中心に、最初から設計されています。",
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Orynx チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Orynx をどのように利用、または活用するご予定ですか?",
        goals: "目標または現在抱えている課題",
        goalsHint:
          "Orynx で実現したいことや、いま直面している課題をお聞かせください。詳しくご記入いただくほど、より的確にお手伝いできます。",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Orynx を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Orynx を連携" },
      ...
      consent: {
        intro:
          "Orynx, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Orynx, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Orynx からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Orynx, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Orynx チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
