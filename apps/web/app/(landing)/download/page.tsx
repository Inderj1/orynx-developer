...
export const metadata: Metadata = {
  title: "Download Orynx",
  description:
    "Download Orynx for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Orynx",
    description:
      "Get the Orynx desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
